                ...
                <nav class="navbar navbar-default">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <button type="button" id="showInList" class="btn btn-default navbar-btn pull-right">
                                <i class="glyphicon glyphicon-th"></i>
                            </button>
                            <button type="button" id="showInTiles" class="btn btn-default navbar-btn pull-right">
